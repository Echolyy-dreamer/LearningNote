...
Users create visible custom CloudWatch Alarms.
Scaling triggers when alarms enter ALARM state.
ASG executes fixed incremental actions, like adding 2 instances.

4. Core Difference
表格FeatureStep ScalingTarget TrackingAlarm OwnershipUser-defined & manualSystem-managed & automatedVisibilityVisible in CloudWatchHidden in consoleTrigger ModelThreshold event-drivenContinuous state evaluationScaling BehaviorFixed step incrementsDynamic proportional adjustment
